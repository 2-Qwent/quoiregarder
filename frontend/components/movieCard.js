            ...
            <div className="block md:hidden space-y-4">
                ...
                <div className="flex justify-center">
                    {props.poster ? (
                        ...
                        <div className="w-48 h-64 sm:w-56 sm:h-80 flex items-center justify-center border border-gray-300 dark:border-gray-600 rounded-lg">
                            <p className="text-gray-500 dark:text-gray-400 text-sm">Aucune image disponible</p>
                        </div>
                    )}
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-2 text-xs sm:text-sm text-foreground bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                        <p><span className="font-medium">Date :</span> {props.releaseDate}</p>
                        <p><span className="font-medium">Durée :</span> {props.runtime ? `${props.runtime} min` : "N/A"}</p>
                        <p><span className="font-medium">Note :</span> {props.voteAverage} ({props.voteCount} votes)</p>
                        <p><span className="font-medium">Langue :</span> {getFrenchLanguage(props.originalLanguage)}</p>
                        <p><span className="font-medium">Genre(s) :</span> {props.genres && props.genres.length > 0 ? props.genres.join(", ") : "N/A"}</p>
                    </div>
